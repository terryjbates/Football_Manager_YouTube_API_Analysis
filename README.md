...
- **Ecosystem**
  - A community of **575** YouTube channels are producing Football Manager content of some kind, with **46%** of these channels meeting the nominal [YouTube Partner Program Eligibility](https://support.google.com/youtube/answer/72851?hl=en&ref_topic=9153642&sjid=13407352636801244061-NC) requirements for monetization based on their number of subscribers.
  ...
  - The distribution of subcribers across YouTube channels is highly skewed; small numbers of creators have significant subscriber amonuts, while larger numbers of creators have much smaller communities.
  ...
  - English is the spoken language in **50%** of all channels. Turkish is the second-most common language with **10.55%**. In third to sixth place:
    - Spanish: **6.88%**
    - Portuguese: **6.42%**
    - French: **4.13%**
    - German: **3.21%**
  - **81%** of languages spoken are European. The non-European languages found were:
    - Indonesian
    - Korean
    - Arabic
    - Japanese
